...
while(~reachedFrequencies.indexOf(frequency) && total < cap){
 ...
 if(i==changes.length){
   i=0;
   total++;
   console.log("Looping through again. " + total + "/" + cap);
 }
}
if(cap==total) console.log("Cancelled. Cap reached");
